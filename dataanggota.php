...
$anggota = query('data_anggota', 'id_anggota', $_GET['id']);
?>
  ...
  <body>
    ...
    <div class="container databuku">
        <div class="card bg-light mb-3">
            <div class="card-header"><h3>Data Anggota</h1></div>
            <div class="card-body row">
                ...
                <div class="col-sm-12 col-md-9 tabeldatabuku">
                    <div class="row">
                        <div class="col-3 data">Nama Anggota</div>
                        <div class="col-9">: <b><?= $anggota[0]['nama'] ?></b></div>
                    </div>
                    <div class="row">
                        <div class="col-3 data">NIK</div>
                        <div class="col-9">: <?= $anggota[0]['nik'] ?></div>
                    </div>
                    <div class="row">
                        <div class="col-3 data">Alamat</div>
                        <div class="col-9">: <?= $anggota[0]['alamat'] ?></div>
                    </div>
                    <div class="row">
                        <div class="col-3 data">E-mail</div>
                        <div class="col-9">: <?= $anggota[0]['email'] ?></div>
                    </div>
                    <div class="row">
                        <div class="col-3 data">No. Telp</div>
                        <div class="col-9">: <?= $anggota[0]['telp'] ?></div>
                    </div>
                </div>
